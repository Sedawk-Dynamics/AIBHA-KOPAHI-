...
export const JOURNAL: JournalEssay[] = [
  ...
  // -------------------------------------------------------------
  {
    ...
    coverImage: "/products/gi-keteki-joha-rice.jpeg",
    readingMinutes: 5,
    inlineFarmerSlugs: ["bireswar-hazarika"],
    inlineProductSlugs: ["gi-keteki-joha-rice"],
    body: [
      { type: "paragraph", text: "The notebook is bound with a rubber band that was never meant to last forty years. Its pages are foxed, its hand is small, and on the inside cover, in faded ink, are five words in Assamese: the year the rains failed." },
      { type: "paragraph", text: "The hand is Bireswar Hazarika's grandfather's. The year was 1983. The rains failed across most of upper Assam, and the aush crop — the early monsoon rice that most paddy households here depend on — did not stand. What did stand, in the four acres of low-lying paddy outside the village of Hatiborhola, was a small reserved patch of Keteki Joha, the aromatic short-grain that the family had always kept for weddings and Bihu." },
      { type: "paragraph", text: "Joha is not a high-yielder. It is fussy about water, slow to mature, and easily lodged in a strong wind. But it is also, the grandfather noted in the small precise hand, the rice that did not die." },
      { type: "paragraph", text: "He wrote down the dates of sowing, the depths of standing water in his paddy that summer, the day-on-day temperatures from the only thermometer in the village, and most usefully of all, the exact location in the four acres where each Keteki strain had been sown. Forty-three years later, his grandson Bireswar still uses the notebook to decide where to sow." },
      { type: "farmerInset", slug: "bireswar-hazarika" },
      { type: "divider" },
      { type: "paragraph", text: "When we first met Bireswar in 2024, we were looking for a Keteki Joha supplier who had not crossed his strain with the higher-yielding modern Joha varieties that the state seed corporation had been pushing for two decades. The high-yielders look identical to the eye. They taste similar in the pot. But they are not, by the definition that the Geographical Indication uses, the same rice. The GI for Keteki Joha — granted in 2018 — protects a specific landrace, with specific morphological markers, grown in a specific belt of Assam. Cross it with a modern variety and you have something perfectly edible that is no longer Keteki." },
      { type: "paragraph", text: "Bireswar's grandfather had, without ever using the word, maintained a seedbank. Every harvest, the best panicles from each row were dried, hand-threshed, and stored in clay pots sealed with cow-dung paste — one pot for the bao (deep-water) strain, one for the sali (winter) strain, one for the prized aromatic Keteki. The pots were passed to Bireswar's father in 1996, and to Bireswar in 2013." },
      { type: "paragraph", text: "When the Karbi Anglong belt began commercial Joha cultivation in the late 2000s, almost every cooperative in the region accepted seed from the state corporation. It was free. It was reliable. It promised higher yield. By 2019, most of the “Keteki Joha” sold from the region was, genetically, a hybrid. Bireswar's four acres were one of the few that had not crossed." },
      { type: "productInset", slug: "gi-keteki-joha-rice" },
      { type: "divider" },
      { type: "paragraph", text: "The economics, of course, are punishing. Bireswar yields about 2.4 tonnes per acre — roughly forty percent less than his neighbours who grow the hybrid. He compensates because we pay him a premium that reflects what the GI is actually worth: not the average mandi rate for “fine-grain rice”, but the price the GI tag earns on a premium retailer's shelf. Roughly four times the standard procurement price, paid weekly, direct to his account." },
      { type: "paragraph", text: "The first time we explained the pricing to him, he listened without interrupting, which is his way. Then he said: “My grandfather's notebook will fetch this price?” We said yes. He said, “Then I think we will keep the notebook in a better place.”" },
      { type: "divider" },
      { type: "paragraph", text: "The seedbank is not a romantic object. It is, in the most literal sense, the only reason the Keteki Joha that ships out of Kopahi's Jorhat facility is genuinely the GI rice and not its higher-yielding cousin. Without the four acres in Hatiborhola, the protected landrace would, in this generation, simply have crossed itself out of existence." },
      { type: "paragraph", text: "Bireswar is sixty-three. His son is studying agricultural engineering at Tezpur University. We have had two conversations with the son. He is interested. He is not yet committed. The notebook, in either case, will sit on the same shelf in the same house for at least the next planting season." },
      { type: "paragraph", text: "We are not, in our company, in the business of guaranteeing futures. We can only guarantee buying terms, prices, and the truth of the labels we put on the bags. The rest is what Bireswar and his son will decide." },
      { type: "paragraph", text: "But the year his grandfather wrote down — the year the rains failed — was the year a small four-acre patch in Karbi Anglong, almost by accident, became one of the most quietly important agricultural archives in Northeast India. Forty-three years on, the GI tag has finally caught up with what the notebook always knew." },
      { type: "authorNote", text: "Ashreeta Gogoi writes from the field desk at Kopahi. She visits Karbi Anglong twice a year." },
    ],
  },
  ...
  // -------------------------------------------------------------
  {
    ...
    body: [
      ...
      { type: "productInset", slug: "gi-karbi-anglong-ginger-powder", note: "for the classic Lakadong-and-ginger pairing the soil itself prefers" },
      { type: "divider" },
      { type: "paragraph", text: "The Lakadong belt produces, in a good year, perhaps two thousand tonnes — a rounding error against the global turmeric trade. The growers here are not poor in the way the popular Northeast story sometimes flattens everyone into being; they are skilled specialists working a difficult crop on difficult land, and the GI tag, properly honoured by the market, finally pays them at the rate the rhizome has always been worth." },
      { type: "paragraph", text: "What the kitchen receives, when it receives Lakadong, is not a wellness commodity. It is a fourteen-day on-plant cure, an altitude, a soil, a curing pit, and the eye of a farmer who, for several generations, chose the brightest rhizome in the basket. The percentage on the lab report is the closing line of a much older story." },
      { type: "authorNote", text: "Barsha Prakash Choudhury writes from the brand desk at Kopahi." },
    ],
  },
  ...
  // -------------------------------------------------------------
  {
    ...
    coverImage: "/products/gi-keteki-joha-rice.jpeg",
    readingMinutes: 4,
    inlineProductSlugs: ["gi-keteki-joha-rice", "gi-karbi-anglong-ginger-powder"],
    body: [
      { type: "paragraph", text: "Most Indian rice is a vehicle. It carries flavour from one element on the plate to another, soaking up gravy on the way. Joha rice is not a vehicle. It is the destination." },
      { type: "paragraph", text: "Khar is the dish that exists, more or less, to let it be that." },
      { type: "divider" },
      { type: "paragraph", text: "Khar is the Assamese name for an alkaline filtrate traditionally made by burning the skin of a sun-dried banana, collecting the ash, soaking it in water, and straining the liquid clear. The result is a pale, faintly mineral liquid — the kharoni — that you use as you would a seasoning, a few tablespoons at a time, to balance richer ingredients with a clean astringent finish." },
      { type: "paragraph", text: "What is on the plate, in a classic Assamese midday meal of bhaat aru khar, is staggeringly simple: a small mound of steamed rice, a separate bowl of khar cooked with raw papaya or a leafy green, a side of aloo pitika (mashed potato with mustard oil and green chilli), and a wedge of lemon. There is no curry. There is no gravy. There is no spice mix doing the heavy lifting." },
      { type: "paragraph", text: "The Joha is the lifting." },
      { type: "productInset", slug: "gi-keteki-joha-rice" },
      { type: "divider" },
      { type: "paragraph", text: "Khar with Joha · Serves 2" },
      { type: "paragraph", text: "For the rice — 150 g GI Keteki Joha rice, rinsed three times in cool water · 280 ml water · A pinch of salt · 1 tsp mustard oil (optional, for the lift)." },
  ...
  // -------------------------------------------------------------
  {
    ...
    body: [
      { type: "paragraph", text: "A jar of jam should not be intimidating. The chilli inside this one is." },
      { type: "paragraph", text: "Our Bhoot Jolokia jam is a small-batch preserve we make in Jorhat using GI-certified ghost chillies from Khrieliezo Dawhuo's terraces above Kohima. It is, by intent, not a hot sauce. It is a finishing condiment — closer in spirit to a fruit chutney than a salsa, with the heat of a Naga chilli carrying through a long-cooked sugar base. The first hit is smoky and almost sweet. The second hit arrives unhurried, climbs the back of the tongue, and stays for somewhere between thirty seconds and a minute." },
      { type: "paragraph", text: "A spoon of it on hot rice will end the meal. A quarter-teaspoon of it on the right cheese will redefine the meal." },
      { type: "divider" },
      { type: "paragraph", text: "Here is what it pairs with." },
      { type: "paragraph", text: "Aged cheddar (2–4 years). The salt in a long-aged cheddar gives the jam something to argue with. The sweetness in the jam cuts the rind-funk. The heat is just enough to make the cheese taste younger. Cut the cheddar in matchbox-sized cubes. A pinhead of jam per cube. A glass of cider next to it." },
      { type: "paragraph", text: "Manchego or any firm sheep's-milk cheese. The nuttiness wraps the chilli. Almost no other condiment does this — most heat overpowers sheep's milk and leaves you tasting only the chilli. Bhoot Jolokia jam, because of the sugar base, finishes long enough that the cheese gets its sentence in." },
      { type: "paragraph", text: "Hard goat's-milk cheese. Trickier. The acid in goat will accelerate the heat. Use half as much jam as you think. Pair with a sweet wine to balance." },
      { type: "paragraph", text: "Soft-rind cheeses (brie, camembert, taleggio). Sparingly, and only on the rind. The cream of a soft-rind cheese will mute the heat for the first two seconds and then it will not. This is a feature, not a bug. Pair with bread and a slow bourbon." },
      { type: "paragraph", text: "Grilled meats — pork, lamb, duck. The classic Northeast pairing. A glaze of the jam, brushed on the last two minutes of grilling, will char beautifully and carry the heat into the meat itself. Reserve some unheated jam to serve at the table." },
      { type: "productInset", slug: "kopahi-bhoot-jolokia-jam", note: "made in Jorhat with chillies from Kohima" },
      { type: "divider" },
      { type: "paragraph", text: "Here is what not to pair it with." },
      { type: "paragraph", text: "Anything cold. Cold cuts heat. The Bhoot Jolokia jam, on cold meat or cold cheese straight from the fridge, will spike. Allow the cheese to come to room temperature for at least twenty minutes before the board goes out." },
      { type: "paragraph", text: "Anything with raw garlic. Raw garlic and Bhoot Jolokia have a fight on the palate that no one wins. The jam plays well with cooked garlic, charred garlic, smoked garlic — never raw." },
      { type: "paragraph", text: "Coriander leaf. The volatile oils in fresh coriander and the smoked notes in our jam cancel each other out. Use mint instead, or basil, or no herb at all." },
      { type: "paragraph", text: "Anything for a young palate. This is not a beginner's condiment. The polite line is not yet." },
      { type: "divider" },
      ...
      { type: "paragraph", text: "Do not lean over it. Turn your head as you unscrew the lid. The first whiff is the warning the chilli has built into itself. Trust it." },
  ...
  // -------------------------------------------------------------
  {
    ...
    body: [
      ...
      { type: "paragraph", text: "This is, in the small ways things become large, what climate is now doing to the calendars of every heritage agricultural product in the region. The first flush is the canary. The rest of the catalogue is on the same clock." },
      { type: "authorNote", text: "Trideep Khanikar runs operations and processing at Kopahi." },
    ],
  },
  ...
  // -------------------------------------------------------------
  {
    ...
    readingMinutes: 4,
    body: [
      { type: "paragraph", text: "The first thing people ask, when they look closely at a Kopahi pack, is what is the white flower at the top?" },
      { type: "paragraph", text: "It is not a flower. It is cotton — kopahi, in Assamese — and the name of the company comes from it." },
      { type: "divider" },
      { type: "paragraph", text: "Cotton, in Assamese cultural memory, is not principally an agricultural product. It is principally a gesture. In an Assamese household, when a guest is welcomed at a doorway, a small offering is sometimes made — a soft white cotton boll, placed in the visitor's hand or pinned to a fold of cloth, as a quiet wordless signal of you are welcome here, you are dear to us, we are pleased that you have come." },
      { type: "paragraph", text: "The gesture is small. It does not appear in textbooks. Children learn it from grandparents, almost without noticing it has been taught." },
      { type: "paragraph", text: "When we were choosing what to call the company in 2023, we considered several names. Most of them were geographical — variations on the word for hill, for river, for valley. They were honest enough but felt, to our ear, descriptive rather than offered. They told the visitor where they were. They did not tell the visitor that they were welcome." },
      { type: "paragraph", text: "Kopahi did." },
      { type: "divider" },
      { type: "paragraph", text: "The bouquet in the logo is, deliberately, three bolls — not one, not two, not a stylised graphic of cotton. Three because in the Assamese gesture, three is the small quiet number of welcome. One boll is too brief. Two is correct but symmetrical and feels formal. Three is the number a grandmother instinctively reaches for when she takes the cotton from the shallow bowl on her shelf and presses it into the visitor's palm." },
      { type: "paragraph", text: "The green script below it is the wordmark in our house serif. The thin gold line beneath the wordmark is a single sweep that, in the early sketches, was meant to read as the curve of the Brahmaputra. It does not have to read that way. It can read as a flourish, a horizon, a thread. We left it ambiguous on purpose." },
      { type: "divider" },
      { type: "paragraph", text: "The reason we are telling this story now, on this part of the website, is that we are increasingly asked — by buyers, by partners, occasionally by journalists — why a tea-and-spice brand uses cotton as its mark. The answer is at once obvious and not. We do not sell cotton. We have, at the moment, no plans to. The mark is not a product index. It is a register of how we mean to receive the visitor — every visitor, on every page, in every packet." },
      { type: "paragraph", text: "The label is, in this small way, the doorway. The cotton is what we put in the visitor's hand as they cross it." },
      { type: "divider" },
      ...
      { type: "paragraph", text: "“It looked like it was offering itself to me,” she wrote. “I had to look it up. Then I had to write to you.”" },
      { type: "paragraph", text: "We replied. We told her, more or less, what is written above." },
