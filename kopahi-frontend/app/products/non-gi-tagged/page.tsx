      ...
      <main className="bg-(--color-ivory) text-(--color-ink)">
        <section className="pt-32 sm:pt-40 pb-10">
          <div className="mx-auto max-w-7xl px-6 sm:px-8 lg:px-12">
            ...
            <Headline as="h1" className="mt-6 max-w-4xl" accent="Built In.">
              Everyday Essentials.
            </Headline>
            <p className="mt-8 max-w-2xl font-display italic text-lg sm:text-xl text-(--color-bamboo) leading-relaxed">
              The pantry shelf that holds the heroes up. Vegetable powders, herbs, tea, and a small-batch preserve —
              each sun-dried with the same care as the GI lineup.
            </p>
          </div>
        </section>
